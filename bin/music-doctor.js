...
const required = ['src/kernel.js', 'src/constitution.js', 'src/actor.js', 'src/world.js', 'src/local-worlds.js', 'src/residency.js', 'src/runtime-provenance.js', 'src/rehearsal.js', 'src/install.js', 'DESIGN.md', 'HATCH.md'];
